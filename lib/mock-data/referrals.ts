...
export const mockReferrals: Referral[] = [
  ...
  // ========================================
  // SCENARIO 7: SIMILAR DOBs FOR RECONCILIATION TESTING
  // These create ambiguous matches for the reconciliation wizard
  // ========================================
  {
    id: 'ref-090',
    firstName: 'Martha',
    lastName: 'Sanchez',
    email: 'martha.sanchez@gmail.com',
    phone: phone(90),
    dateOfBirth: '1968-03-17', // 2 days off from Maria Santos (1968-03-15)
    submittedAt: daysAgo(20),
    source: 'Facebook',
    studyId: 'study-001',
    status: 'signed_icf',
  ...
  },
  {
    ...
    firstName: 'Mark',
    lastName: 'Stevens',
    email: 'mstevens@yahoo.com',
    phone: phone(91),
    dateOfBirth: '1968-03-12', // 3 days off from Maria Santos (1968-03-15)
    submittedAt: daysAgo(22),
    source: 'Google',
    studyId: 'study-001',
    status: 'appointment_scheduled',
  ...
  },
  {
    ...
    firstName: 'Walter',
    lastName: 'Jones',
    email: 'wjones@outlook.com',
    phone: phone(92),
    dateOfBirth: '1965-08-25', // 3 days off from William Johnson (1965-08-22)
    submittedAt: daysAgo(26),
    source: 'Referral',
    studyId: 'study-001',
    status: 'signed_icf',
  ...
  },
  {
    ...
    phone: phone(93),
    dateOfBirth: '1965-08-19', // 3 days off from William Johnson (1965-08-22)
    submittedAt: daysAgo(24),
    source: 'Facebook',
    studyId: 'study-001',
    status: 'appointment_scheduled',
  ...
  },
  {
    ...
    firstName: 'Carmen',
    lastName: 'Brown',
    email: 'cbrown2@gmail.com',
    phone: phone(94),
    dateOfBirth: '1958-11-28', // 2 days off from Charles Brown (1958-11-30)
    submittedAt: daysAgo(28),
    source: 'Instagram',
    studyId: 'study-001',
    status: 'signed_icf',
  ...
  },
  {
    ...
    firstName: 'Janet',
    lastName: 'Davidson',
    email: 'jdavidson@yahoo.com',
    phone: phone(95),
    dateOfBirth: '1967-04-27', // 2 days off from Jennifer Davis (1967-04-25)
    submittedAt: daysAgo(18),
    source: 'Google',
    studyId: 'study-001',
    status: 'appointment_scheduled',
  ...
  },
  {
    ...
    firstName: 'Diana',
    lastName: 'Walker',
    email: 'dwalker@outlook.com',
    phone: phone(96),
    dateOfBirth: '1963-05-10', // 2 days off from Dorothy Wilson (1963-05-12)
    submittedAt: daysAgo(23),
    source: 'Facebook',
    studyId: 'study-001',
    status: 'signed_icf',
  ...
  },
  {
    ...
    firstName: 'Chris',
    lastName: 'Morrison',
    email: 'cmorrison@gmail.com',
    phone: phone(97),
    dateOfBirth: '1964-06-18', // 3 days off from Christopher Martinez (1964-06-15)
    submittedAt: daysAgo(19),
    source: 'Referral',
    studyId: 'study-001',
    status: 'appointment_scheduled',
  ...
  },
  {
    ...
    phone: phone(98),
    dateOfBirth: '1959-03-20', // 2 days off from Linda Taylor (1959-03-22)
    submittedAt: daysAgo(24),
    source: 'Instagram',
    studyId: 'study-001',
    status: 'signed_icf',
  ...
  },
  {
    ...
    firstName: 'Larry',
    lastName: 'Thomas',
    email: 'lthomas@outlook.com',
    phone: phone(99),
    dateOfBirth: '1959-03-25', // 3 days off from Linda Taylor (1959-03-22)
    submittedAt: daysAgo(21),
    source: 'Google',
    studyId: 'study-001',
    status: 'appointment_scheduled',
